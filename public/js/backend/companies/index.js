$(function() {
  ...
  const TRIANGLE_IMAGE_FOR_FILTER =
    "data:image/png;base64,";
  ...
  var formatActionField = function(row, cell, formatterParams) {
    return (
      ...
      "<span onclick=\"javascript:if(confirm('Are you sure want to delete this Data？')) { document.getElementById('form-delete-" +
      row.getData()["id"] +
      '\').submit(); } return false;" class="btn btn-warning btn-delete" title="削除"><i class="fa fa-trash"></i></span>' +
      "</form>"
    );
  }; // Formatter for edit/delete
  ...
  $("#datalist").tabulator(
    "setData",
    rootUrl + "/api/admin/companies/getCompaniesTabular"
  );
